...
root_dir = "../"
default_input_dir = root_dir + "AutoDL_input_data_1"
default_output_dir = root_dir + "AutoDL_sample_result_submission"
default_program_dir = root_dir + "AutoDL_ingestion_program"
default_submission_dir = root_dir + "AutoDL_sample_code_submission"
