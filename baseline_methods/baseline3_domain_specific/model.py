...
class Model(algorithm.Algorithm):
  ...
  def tabular_model_fn(self, features, labels, mode):
    """Model function for tabular dataset.

    Dense neural network with 0 hidden layer.
    """
    print_log("Constructing model function for tabular dataset...")
  ...
  def video_model_fn(self, features, labels, mode):
    ...
    """
    print_log("Constructing model function for video dataset...")
  ...
  def speech_model_fn(self, features, labels, mode):
    """Model function for speech dataset.

    TODO
    """
    print_log("Constructing model function for speech dataset...")
  ...
  def text_model_fn(self, features, labels, mode):
    """Model function for speech dataset.

    TODO
    """
    print_log("Constructing model function for text dataset...")
  ...
  def image_model_fn(self, features, labels, mode):
    """Auto-Scaling CNN model for image datasets."""
    print_log("Constructing model function for image dataset...")
    col_count, row_count = self.metadata_.get_matrix_size(0)
    sequence_size = self.metadata_.get_sequence_size()
    output_dim = self.metadata_.get_output_size()
